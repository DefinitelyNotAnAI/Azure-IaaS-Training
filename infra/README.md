...
```powershell
az login --tenant 3d50d380-fed3-48c7-b967-3fd8026cc60b
Connect-AzAccount -Tenant 3d50d380-fed3-48c7-b967-3fd8026cc60b `
  -Subscription "ME-MngEnvMCAP475636-lerobbi-1"
```
...
| `SESSION_ID` | Partition key for this cohort, e.g. `quanta-2026-07-15` |
...
.\infra\seed-cohort.ps1 `
  -SessionId "quanta-2026-07-15" `
  -StorageAccount "wkstoreXXXXXX" `
  -SlotCount 25   # default 30
```

For each slot (user01…userXX):
1. Creates Entra ID user `userXX@MngEnvMCAP475636.onmicrosoft.com`
...
.\infra\peer-hub.ps1 -SessionId "quanta-2026-07-15"

# Or a single straggler
.\infra\peer-hub.ps1 -SessionId "quanta-2026-07-15" -Slot user07
```
...
.\infra\export-cohort.ps1 `
  -SessionId "quanta-2026-07-15" `
  -StorageAccount "wkstoreXXXXXX" `
  -OutputPath ".\exports\quanta-2026-07-15.csv"
```
...
```powershell
.\infra\teardown-cohort.ps1 -SessionId "quanta-2026-07-15" -StorageAccount "wkstoreXXXXXX" -WhatIf
```
