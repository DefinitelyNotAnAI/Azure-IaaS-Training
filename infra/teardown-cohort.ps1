...
.EXAMPLE
  .\teardown-cohort.ps1 -SessionId quanta-2026-07-15 -StorageAccount wkstore4a2f1b
  .\teardown-cohort.ps1 -SessionId quanta-2026-07-15 -StorageAccount wkstore4a2f1b -WhatIf
#>
